        ...
        <div className="grid gap-14 lg:grid-cols-12 lg:gap-16">
          ...
          >
            ...
            >
              Refer someone
              <br />
              <span className="italic font-light text-white/75">to Bright Pvt.</span>
            </motion.h1>
            ...
            >
              Families, participants, GPs, coordinators, and organisations can
              use this form to start a referral. We&apos;ll review it and follow up
              with the contacts provided.
            </motion.p>

            <motion.p variants={fadeUp} className="mt-4 max-w-md text-[14px] text-white/75">
              General questions?{" "}
              <Link
                href="/contact"
